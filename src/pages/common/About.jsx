        ...
        <div className={styles.logistics_area}>
          <div className={styles.row}>
            <div className={styles.logistics_content}>
              <h2 className={styles.section_title}>About Our SwiftSend</h2>
              <p className={styles.text}>
                Welcome to SwiftSend service, your trusted partner in logistics.
              ...
              <img
                src={logistics1}
                alt="logistics"
                className={styles.logistics_img}
              />
            </div>
          </div>
        </div>
      ...
      <section className={styles.image_text_section}>
        <div className={styles.text_container}>
          ...
          <p className={styles.text}>
            ...
            our clients to understand their needs, develop customized logistics
            solutions, and provide ongoing support throughout the entire
